...
{
    public class WhenNotificationIsNotSuccessful : CommandHandlerSpecification<ProcessWindowsNotificationCommand>
    {
        ...
        protected override void BuildServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IWindowsNotificationProcessor>(new FakeWindowsNotificationProcessor(true, _exception));
        }
