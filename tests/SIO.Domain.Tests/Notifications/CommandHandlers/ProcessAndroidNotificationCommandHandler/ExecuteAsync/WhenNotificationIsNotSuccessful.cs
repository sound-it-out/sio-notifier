...
namespace SIO.Domain.Tests.Notifications.CommandHandlers.ProcessAndroidNotificationCommandHandler.ExecuteAsync
{
    public class WhenNotificationIsNotSuccessful : CommandHandlerSpecification<ProcessAndroidNotificationCommand>
    {
        ...
        protected override void BuildServices(IServiceCollection services)
        {
            ...
            services.RemoveAll<IAndroidNotificationMessageBuilder>();
            services.AddSingleton<IAndroidNotificationMessageBuilder, FakeAndroidNotificationMessageBuilder>();
            services.AddSingleton<IAndroidNotificationProcessor>(new FakeAndroidNotificationProcessor(true, _exception));
        }

        protected override ProcessAndroidNotificationCommand Given()
        {
            return new ProcessAndroidNotificationCommand(_aggregateId, _correlationId, 1, _userId);
        }
