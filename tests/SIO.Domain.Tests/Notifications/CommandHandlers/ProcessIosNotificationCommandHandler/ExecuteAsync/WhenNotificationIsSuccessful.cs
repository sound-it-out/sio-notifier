...
{
    public class WhenNotificationIsSuccessful : CommandHandlerSpecification<ProcessIosNotificationCommand>
    {
        ...
        protected override void BuildServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IIosNotificationProcessor>(new FakeIosNotificationProcessor(false, ""));
        }
