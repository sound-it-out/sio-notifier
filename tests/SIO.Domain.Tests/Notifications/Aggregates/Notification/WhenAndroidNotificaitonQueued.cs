...
{
    public class WhenAndroidNotificaitonQueued : AggregateSpecification<Domain.Notifications.Aggregates.Notification, NotificationState>
    {
        ...
        {
            Aggregate.QueueForAndroid(_aggregateId, _payload, _template, _tags);
        }
        ...
        [Then]
        public void ShouldContainUncommitedAndroidNotificationQueuedEvent()
        {
            var events = Aggregate.GetUncommittedEvents();

            events.Single().Should().BeOfType<AndroidNotificationQueued>();
        }

        [Then]
        public void ShouldContainUncommitedAndroidNotificationQueuedEventWithCorrectAggregateId()
        {
            var events = Aggregate.GetUncommittedEvents();

            var @event = events.OfType<AndroidNotificationQueued>().Single();

            @event.AggregateId.Should().Be(_aggregateId);
        }

        [Then]
        public void ShouldContainUncommitedAndroidNotificationQueuedEventWithCorrectPayload()
        {
            var events = Aggregate.GetUncommittedEvents();
        ...
        [Then]
        public void ShouldContainUncommitedAndroidNotificationQueuedEventWithCorrectTemplate()
        {
            var events = Aggregate.GetUncommittedEvents();
            var @event = events.OfType<AndroidNotificationQueued>().Single();
        ...
        [Then]
        public void ShouldContainUncommitedAndroidNotificationQueuedEventWithCorrectTags()
        {
            var events = Aggregate.GetUncommittedEvents();
            var @event = events.OfType<AndroidNotificationQueued>().Single();
        ...
        [Then]
        public void ShouldContainUncommitedAndroidNotificationQueuedEventWithCorrectVersion()
        {
            var events = Aggregate.GetUncommittedEvents();
            var @event = events.OfType<AndroidNotificationQueued>().Single();
