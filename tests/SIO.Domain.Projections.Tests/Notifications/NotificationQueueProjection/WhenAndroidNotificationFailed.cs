...
{
    public class WhenAndroidNotificationFailed : ProjectionSpecification<Projections.Notifications.NotificationQueueProjection>
    {
        ...
        {
            var notification = Context.Find<NotificationQueue>(_aggregateId);
            notification.Type.Should().Be(NotificationType.Android);
        }
