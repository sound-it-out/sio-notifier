...
{
    public class WhenNotificationIsSuccessful : CommandHandlerSpecification<ProcessAndroidNotificationCommand>
    {
        ...
        protected override void BuildServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAndroidNotificationProcessor>(new FakeAndroidNotificationProcessor(false, ""));
        }
